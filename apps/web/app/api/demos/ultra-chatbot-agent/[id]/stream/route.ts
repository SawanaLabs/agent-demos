import { handleUltraChatbotAgentStreamResumeRequest } from "@/features/ultra-chatbot-agent/server/runtime";
import {
...
export async function GET(
  ...
  const response = await handleUltraChatbotAgentStreamResumeRequest(id, {
