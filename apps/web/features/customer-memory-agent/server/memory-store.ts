import { and, desc, eq, inArray, ne, sql } from "@workspace/database/drizzle";
...
interface CustomerMemoryDatabaseModule {
  customerMemoryEvents: typeof import("@workspace/database")["customerMemoryEvents"];
...
async function loadCustomerMemoryAgentDatabase(): Promise<CustomerMemoryDatabaseModule> {
  ...
  return {
    customerMemoryEvents: databaseModule.customerMemoryEvents,
