...
export type MultimodalChatbotSetupState =
  AiGatewayContractSetupState<AiGatewaySetupConfig>;

export type MultimodalChatbotGateway = ReturnType<
...
const multimodalChatbotContract = {
  ...
  missingApiKeyError:
    "Missing AI_GATEWAY_API_KEY. Add it to .env.local before using the multimodal chatbot.",
  missingApiKeyIssue:
