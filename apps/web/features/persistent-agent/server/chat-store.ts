import { and, asc, desc, eq, lt } from "@workspace/database/drizzle";
...
interface PersistentAgentDatabaseModule {
  database: typeof import("@workspace/database")["database"];
  persistentAgentChats: typeof import("@workspace/database")["persistentAgentChats"];
  persistentAgentMessages: typeof import("@workspace/database")["persistentAgentMessages"];
}
...
async function loadPersistentAgentDatabase(): Promise<PersistentAgentDatabaseModule> {
  ...
  return {
    ...
    persistentAgentChats: databaseModule.persistentAgentChats,
    persistentAgentMessages: databaseModule.persistentAgentMessages,
  };
}
