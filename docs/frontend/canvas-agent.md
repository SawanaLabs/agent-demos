...
- Canvas Agent and text generation default to `openai/gpt-5-mini`; `AI_GATEWAY_CHAT_MODEL` can override it. Browser acceptance with the former `gpt-4.1-mini` default repeatedly omitted source-image edges on character-consistent follow-ups.
