...
- Offer Primary (default), Red (the shared destructive token), Black, Green, and Yellow beside Draw. Store color per stroke and preserve it in both the preview and baked screenshot; changing pens must not recolor existing strokes.
