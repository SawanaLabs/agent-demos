...
Use this domain when changing the Next.js app, shared UI package, Tailwind setup, or component import paths.
...
- [Customer Memory Agent](./customer-memory-agent.md): Batch 6 rules for shared demo accounts, visitor-private sandbox threads, and cookie-scoped memory persistence.
