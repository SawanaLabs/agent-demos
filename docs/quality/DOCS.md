...
- **Resource Abuse and Privacy Review**: A focused readiness review for model/provider spend, hosted resources, visitor-private data, and project code integrity.
...
- Update [Resource Abuse and Privacy Review](./resource-abuse-privacy-review.md) when abuse, privacy, or code-integrity review scope changes.
