...
function buildRecordFetchError(recordId: string, error: unknown): ContentReviewRecord {
  return {
    errorMessage:
...
export interface ContentReviewSessionController {
...
export function useContentReviewSession(): ContentReviewSessionController {
